...
#define LEGCONTROL_SPRINGDAMPING_PID_POSITION_KP 1000.0f
#define LEGCONTROL_SPRINGDAMPING_PID_POSITION_KI   0.0f
#define LEGCONTROL_SPRINGDAMPING_PID_POSITION_KD  80.0f

#define LEGCONTROL_COMPENSATIONROLL_PID_POSITION_KP    1000.0f
#define LEGCONTROL_COMPENSATIONROLL_PID_POSITION_KI    0.0f
#define LEGCONTROL_COMPENSATIONROLL_PID_POSITION_KD    50.0f
