...
public:
    ...
    virtual void exit() = 0;
    virtual JFSMode checkTransition(JFSMode next_state) {return JFSMode::ZEROTAU;}
    JFSMode stateName;
protected:
...
public:
    ...
    void enter();
    void exit();
    JFSMode checkTransition(JFSMode next_state);  
};
...
public:
    ...
    ~JFSM();
    void JFSMUpdate();
    JFSMode setZeroTauState(){return nextState = JFSMode::ZEROTAU;}
    JFSMode setCaliState(){return nextState = JFSMode::CALI;}
    JFSMode setReadyState(){return nextState = JFSMode::READY;}
    JFSMode setDampingState(){return nextState = JFSMode::DAMPING;}
    JFSMode setResetState(){return nextState = JFSMode::RESET;}
    JFSMode getCurrentState(){return currentStatePtr->stateName;}
    bool ifReady(){return getCurrentState() == JFSMode::READY;}
private:
    JFSMStateBase* getNextState(JFSMode stateName);
