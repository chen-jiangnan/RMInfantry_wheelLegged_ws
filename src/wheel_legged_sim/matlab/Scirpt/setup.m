...
eqs = [eqn_11;eqn_12;eqn_14;eqn_15;eqn_16;eqn_17;eqn_18;eqn_19]
...
A = subs(jacobian([theta_dot,f1,x_dot,f2,phi_dot,f3],[theta,theta_dot,x,x_dot,phi,phi_dot]),[theta,theta_dot,x,x_dot,phi,phi_dot,T,Tp],[0,0,x,0,0,0,0,0])
